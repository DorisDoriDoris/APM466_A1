...
for (i in 1:10){#iteration over 10 days of observation
  ...
  b=1;c=data[b,4]/2
  #ytm
  ytm_bond_1[i]= as.numeric(-ln(((data[b,5+i]))/(N+c))/(data[b,25+i]))
  #spot rate
  yield_1[i] = as.numeric(-ln((data[b,5+i])/(N+c))/(data[b,25+i]))
  ...
  #spot rate
  yield_2[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t2_1*yield_1[i]))/(100+c)))/t2_2)
  ...
  #spot rate
  yield_3[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t3_1*yield_1[i])-c*exp(-t3_2*yield_2[i]))
                       /(100+c)))/t3_3)
  ...
  #spot rate
  yield_4[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t4_1*yield_1[i])
  ...
  #spot rate
  yield_5[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t5_1*yield_1[i])
  ...
  #spot rate
  yield_6[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t6_1*yield_1[i])
  ...
  #spot rate
  yield_7[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t7_1*yield_1[i])
  ...
  #spot rate
  yield_8[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t8_1*yield_1[i])
  ...
  #spot rate
  yield_9[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t9_1*yield_1[i])
  ...
  #spot rate
  yield_10[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t10_1*yield_1[i])
  ...
  b=11;c=data[b,4]/2
  t11_1 = data[b,25+i] - 10 *0.5
  t11_2 = data[b,25+i] - 9 *0.5
  t11_3 = data[b,25+i] - 8 *0.5
  t11_4 = data[b,25+i] - 7 *0.5
  t11_5 = data[b,25+i] - 6 *0.5
  t11_6 = data[b,25+i] - 5 *0.5
  t11_7 = data[b,25+i] - 4 *0.5
  t11_8 = data[b,25+i] - 3 *0.5
  t11_9 = data[b,25+i] - 2 *0.5
  t11_10 = data[b,25+i] - 1 *0.5
  t11_11 = data[b,25+i] 
  #ytm
  ...
  #spot rate
  yield_11[i] = as.numeric((-ln(((data[b,5+i])-c*exp(-t11_1*yield_1[i])
                        -c*exp(-t11_2*yield_2[i])
                        -c*exp(-t11_3*yield_3[i])
                        -c*exp(-t11_4*yield_4[i])
